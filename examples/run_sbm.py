...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-node2vec", "--node2vec", help="whether to run node2vec (default: False)"
    )
    ...
    G = H
    try:
        node_colors = pickle.load(open("data/sbm_node_labels.pickle", "rb"))
    ...
    for embedding in models:
        ...
        viz.plot_embedding2D(
            embedding.get_embedding(), di_graph=G, node_colors=node_colors_arr
        )
